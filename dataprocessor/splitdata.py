...
#     if os.path.exists(save_root):shutil.rmtree(save_root); os.makedirs(save_root)
...
#     split_cls_data("data/changxing/datasetV1")
import os
print(len(os.listdir("data/changxing/datasetV1_cls5/val/defect")))